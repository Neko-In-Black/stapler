...
class UploadedFile implements FileInterface
{
     ...
     * Constructor method.
     *
     * @param  SymfonyUploadedFile  $uploadedFile  The underlying uploaded file object that acts
     * as part of this class's composition.
     */
    public function __construct(protected SymfonyUploadedFile $uploadedFile)
    {
    }
    ...
    {
        return $this->uploadedFile->getMaxFilesize();
    }
