...
class NativeConfig implements ConfigInterface
{
    ...
    protected $items = [
        ...
        'bindings' => [
            'attachment' => '\Neko\Stapler\Attachment',
            'interpolator' => '\Neko\Stapler\Interpolator',
            'resizer' => '\Neko\Stapler\File\Image\Resizer',
            'style' => '\Neko\Stapler\Style',
            'validator' => '\Neko\Stapler\Validator',
        ]
    ];
