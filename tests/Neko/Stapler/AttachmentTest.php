...
class AttachmentTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function build_attachment()
    {
        ...
        $attachmentConfig = new \Neko\Stapler\AttachmentConfig('photo', [
            'styles' => [],
        ...
        $resizer = new \Neko\Stapler\File\Image\Resizer($imagine);

        $attachment = new \Neko\Stapler\Attachment($attachmentConfig, $interpolator, $resizer);
        $attachment->setInstance($instance);

        $storageDriver = new \Neko\Stapler\Storage\Filesystem($attachment);
    ...
    {
        $instance = m::mock('Neko\Stapler\ORM\StaplerableInterface');
