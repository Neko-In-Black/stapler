...
class AttachmentConfigTest extends PHPUnit_Framework_TestCase
{
    ...
    public function it_should_be_able_build_an_array_of_style_objects()
    {
        ...
        $this->assertInstanceOf('Neko\Stapler\Interfaces\Style', $attachmentConfig->styles[0]);
    }
     ...
     *
     * @test
     * @expectedException \Neko\Stapler\Exceptions\InvalidAttachmentConfigurationException
     */
